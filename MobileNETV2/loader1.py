...
class my_dataset(Dataset):
    def __init__(self, path=os.getcwd() + '/data/', train=False, test=False, eval=False):
        ...
        if train:
            ...
            '''
            np.save('./' + ent_num + '/data/test_data', test_data) 
            np.save('./' + ent_num + '/data//test_label', test_label)

            np.save('./' + ent_num + '/data/eval_data', eval_data) 
            np.save('./' + ent_num + '/data/eval_label', eval_label)

            np.save('./' + ent_num + '/data/train_data', train_data) 
            np.save('./' + ent_num + '/data/train_label', train_label)
            '''
            ...
            self.data = np.load('./' + ent_num + '/data/test_data.npy')
            self.label = np.load('./' + ent_num + '/data/test_label.npy')

        elif eval:
            self.data = np.load('./' + ent_num + '/data/eval_data.npy')
            self.label = np.load('./' + ent_num + '/data/eval_label.npy')
